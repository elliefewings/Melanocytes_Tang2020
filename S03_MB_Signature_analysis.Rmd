...
df.ucsf <- read.table("ucsf_mutation_list_csq_UV_MAF_20200211.txt", header = TRUE, stringsAsFactors = FALSE)
...
# Import data - table is aggregation of all validated mutation calls from samples
df.exome <- read.table("exome_mutation_list_csq_UV_MAF_20200211.txt", header = TRUE, stringsAsFactors = FALSE)
